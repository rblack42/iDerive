...
4. Issue a "Pull Request" that will notify me of proposed changes. I will
   review them and merge your changes into the project if they look useful.

Requesting a Feature
********************

If you think of a feature you think would make this tool more useful to those
doing math manually, please generate a "Feature request". This can be done from
the :menuselection:`Issues` menu item on the project age.
